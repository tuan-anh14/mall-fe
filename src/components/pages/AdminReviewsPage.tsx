              ...
              <div key={review.id} className="px-4 py-4 hover:bg-white/[0.02] flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <p className="text-foreground font-medium text-sm truncate">{review.product.name}</p>
        ...
        <AlertDialogContent className="bg-secondary border-border">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground">
              Xóa đánh giá của <strong className="text-foreground">{deleteTarget?.user.firstName} {deleteTarget?.user.lastName}</strong> về sản phẩm <strong className="text-foreground">{deleteTarget?.product.name}</strong>.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
