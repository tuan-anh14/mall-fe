  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl text-white">Quản lý Ví</h1>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10">
              <th className="text-left p-4 text-white/50 text-sm font-medium">Người dùng</th>
              <th className="text-left p-4 text-white/50 text-sm font-medium">Email</th>
              <th className="text-right p-4 text-white/50 text-sm font-medium">Số dư</th>
              <th className="text-right p-4 text-white/50 text-sm font-medium">Giao dịch</th>
              <th className="text-right p-4 text-white/50 text-sm font-medium">Thao tác</th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/40 text-xs capitalize">{w.user.userType.toLowerCase()}</p>
                      </div>
                    </div>
                  </td>
          ...
          {selectedWallet && (
            <div className="space-y-4 mt-2">
              ...
              <div className="bg-white/5 rounded-xl p-4">
                ...
                <p className="text-white/50 text-sm">{selectedWallet.user.email}</p>
