      ...
      <div className="container mx-auto px-4 max-w-xl">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {/* Profile header */}
            <div className="bg-foreground/5 border border-border rounded-2xl p-8 text-center">
              ...
              <h1 className="text-2xl text-foreground mb-1">{profile.name}</h1>
              {profile.memberSince && (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-foreground/5 border border-border rounded-xl p-6 text-center">
                ...
                <p className="text-3xl text-foreground mb-1">{profile.orderCount}</p>
                <p className="text-sm text-muted-foreground">Đơn hàng</p>
              </div>
              <div className="bg-foreground/5 border border-border rounded-xl p-6 text-center">
                <Star className="h-8 w-8 text-yellow-400 mx-auto mb-2" />
                <p className="text-3xl text-foreground mb-1">{profile.reviewCount}</p>
