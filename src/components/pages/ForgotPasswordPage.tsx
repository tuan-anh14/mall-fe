          ...
          {!submitted ? (
            <>
              <div className="mb-8 text-center">
                ...
                <h2 className="text-2xl text-foreground mb-2">Quên mật khẩu?</h2>
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl text-foreground mb-2">Kiểm tra email</h2>
              <p className="text-muted-foreground mb-6">
                Chúng tôi đã gửi liên kết đặt lại mật khẩu đến <strong className="text-foreground">{submittedEmail}</strong>
              </p>
