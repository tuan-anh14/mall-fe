  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Mã giảm giá của shop</h1>
            ...
            <table className="w-full min-w-[750px]">
              <thead>
                <tr className="border-b border-border text-left">
                  ...
                  <th className="px-6 py-4 text-muted-foreground text-sm font-medium">Loại / Giá trị</th>
                  <th className="px-6 py-4 text-muted-foreground text-sm font-medium">Đã dùng</th>
                  <th className="px-6 py-4 text-muted-foreground text-sm font-medium">Đơn tối thiểu</th>
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-white/[0.02]">
                      <td className="px-6 py-4">
                        <span className="font-mono font-bold text-foreground text-sm flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="bg-foreground/5 border-border uppercase"
                />
              </div>
              <div className="space-y-1.5">
